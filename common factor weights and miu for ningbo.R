...
{
  lag_state_matrix_for_miu_estimation[,t]=factor_autoreg_weight*factor_miu[state_variable[,t]+1,]
  advanced_state_matrix_for_miu_estimation[,t]=-factor_miu[state_variable[,t+1]+1,]
}


state_matrix_for_miu_estimation=rbind(advanced_state_matrix_for_miu_estimation,lag_state_matrix_for_miu_estimation)

state_matrix_for_miu_estimation=t(state_matrix_for_miu_estimation)

miu_for_miu_estimation=solve(1+t(state_matrix_for_miu_estimation)%*%state_matrix_for_miu_estimation)%*%(t(state_matrix_for_miu_estimation)%*%t(-factor_for_state_estimation))

sigma2_for_miu_estimation=solve(1+t(state_matrix_for_miu_estimation)%*%state_matrix_for_miu_estimation)
